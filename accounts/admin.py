...
class Account_modeladmin(UserAdmin):
    list_display = (
    'username', 'email', 'date_joined', 'last_login', 'is_admin', 'is_active', 'is_staff', 'is_superuser')
...
class UserProfile_modelAdmin(admin.ModelAdmin):
    ...
    list_display = ('thumbnail', 'user', 'road', 'ward', 'district', 'city', 'bio')
    list_filter = ('user', 'city', 'district', 'ward',)
    search_fields = ('user', 'city', 'district', 'ward',)
    ordering = ('user',)
